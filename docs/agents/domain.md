...
Multi-context repo (MoonBit workspace):
...
├── libs/
│   ├── CONTEXT.md
│   └── docs/adr/                      ← libs-specific decisions
├── moonstore/
│   ├── CONTEXT.md
│   └── docs/adr/                      ← moonstore-specific decisions
├── queryx/
│   ├── CONTEXT.md
│   └── docs/adr/                      ← queryx-specific decisions
└── foxql/
    ├── CONTEXT.md
    └── docs/adr/                      ← foxql-specific decisions
```
...
> _Contradicts ADR-0007 (event-sorted orders) — but worth reopening because…_
